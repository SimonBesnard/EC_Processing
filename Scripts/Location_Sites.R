...
# 2. Create a table with description of the site
...
dfAll_Sites<- dfAll_Sites[c("Site_ID",  "Type_Flux", "Annual_Preci", "Tair", "Stand_Age", "values")] 

# Reorganise dataframe
dfAll_Sites<-spread(dfAll_Sites, Type_Flux, values)
dfAll_Sites<- dfAll_Sites[c("Site_ID",  "NEP", "GPP", "Respiration", "Stand_Age", "Annual_Preci", "Tair")] 
